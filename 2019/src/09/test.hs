  ...
  describe "2019 Day 9" $ do
    context "Run relative tests" $ do
      ...
      it "Relative stuff happens" $
        runProgram 
          (fromList [109,20,109,25,1101,2,2,15,204,-30,99]) [] `shouldBe` 
      ...
      it "1102,34915192,34915192,7,4,7,99,0 outputs a 16 digit number" $
        runProgram 
          (fromList [1102,34915192,34915192,7,4,7,99,0]) [] `shouldBe` 
      ...
      it "104,1125899906842624,99 outputs a large number" $
        runProgram 
          (fromList [104,1125899906842624,99]) [] `shouldBe` 
    ...
    context "Run Day 5 tests" $ do
      ...
      it "3,3,1105,-1,9,1101,0,0,12,4,12,99,1 and input 0 outputs 0" $
        runProgram (fromList [3,3,1105,-1,9,1101,0,0,12,4,12,99,1]) [0] `shouldBe` (fromList [3,3,1105,0,9,1101,0,0,12,4,12,99],11,[0])
